  ...
  const suggestedActions = [
    {
      title: '创建一个',
      label: '专业的客服智能体',
      action: '创建一个专业的客服智能体，能够处理用户咨询和问题解答',
    },
    {
      title: '构建一个',
      label: '数据分析助手',
      action: '构建一个数据分析助手，可以处理和分析各种数据格式',
    },
    {
      title: '设计一个',
      label: '内容创作智能体',
      action: '设计一个内容创作智能体，帮助生成高质量的文章和创意内容',
    },
    {
      title: '开发一个',
      label: '代码审查助手',
      action: '开发一个代码审查助手，能够检查代码质量和提供改进建议',
    },
  ];
