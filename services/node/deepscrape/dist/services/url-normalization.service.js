...
class UrlNormalizationService {
    ...
    static normalizeUrl(url) {
        try {
            ...
            logger_1.logger.warn(`Failed to normalize URL: ${url}`, { error: error.message });
     ...
     */
    static generateSimilarUrls(url) {
        ...
        try {
            ...
            logger_1.logger.warn(`Failed to generate similar URLs for: ${url}`, { error: error.message });
            return [normalized];
        }
    }
    /**
    ...
    static extractDomain(url) {
        try {
            ...
            logger_1.logger.warn(`Failed to extract domain from URL: ${url}`, { error: error.message });
            return '';
        }
    }
    /**
    ...
    static isFileUrl(url) {
        ...
        try {
            ...
            logger_1.logger.debug('Invalid URL format', { url, error: error.message });
            return false;
        }
    }
    /**
    ...
    static isValidUrl(url) {
        try {
            ...
            logger_1.logger.debug('Invalid URL for validation', { url, error: error.message });
            return false;
        }
    }
    /**
    ...
    static getUrlDepth(url) {
        try {
            ...
            logger_1.logger.debug('Failed to get URL depth', { url, error: error.message });
            return 0;
        }
    }
    /**
     ...
     */
    static addSlashVariations(normalized, variations) {
     ...
     */
    static addWwwVariations(parsedUrl, normalized, variations) {
     ...
     */
    static addWithoutWwwVariations(normalized, variations) {
     ...
     */
    static addWithWwwVariations(normalized, variations) {
     ...
     */
    static addProtocolVariations(parsedUrl, normalized, variations) {
     ...
     */
    static addIndexHtmlVariations(parsedUrl, normalized, variations) {
...
UrlNormalizationService.TRACKING_PARAMS = [
