...
describe('LLM Provider Tests', () => {
    ...
    describe('LLMServiceFactory', () => {
        it('should create OpenAI service by default', () => {
            ...
            const service = llm_service_factory_1.LLMServiceFactory.createLLMService();
            expect(service).toBeInstanceOf(openai_service_1.OpenAIService);
        ...
        it('should create vLLM service when provider is set', () => {
            ...
            const service = llm_service_factory_1.LLMServiceFactory.createLLMService();
            expect(service).toBeInstanceOf(local_llm_service_1.LocalLLMService);
    ...
    describe('LocalLLMService', () => {
        ...
        it('should handle vLLM provider headers', () => {
            ...
            const service = new local_llm_service_1.LocalLLMService({
                provider: 'vllm',
        ...
        it('should handle provider-specific response format support', () => {
            const vllmService = new local_llm_service_1.LocalLLMService({
                provider: 'vllm',
                baseUrl: 'http://localhost:8000/v1',
                apiKey: 'dummy-key',
                model: 'model'
            });
            const ollamaService = new local_llm_service_1.LocalLLMService({
                provider: 'ollama',
                baseUrl: 'http://localhost:11434/v1',
                apiKey: 'dummy-key',
                model: 'model'
    ...
    describe('Integration Tests', () => {
        ...
        describe.skip('Live Provider Tests', () => {
            ...
            it('should get completion from provider', async () => {
                ...
                const response = await service.getCompletion(messages, {
                    temperature: 0.1,
                    maxTokens: 10
                });
