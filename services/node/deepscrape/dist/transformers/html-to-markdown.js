...
// NOTE: Order matters! More specific selectors should come first to avoid over-extraction
const MAIN_CONTENT_SELECTORS = [
    // 中国政府网站常用选择器 - 优先级最高，避免被通用选择器覆盖
    '#Zoom', // 政府网站内容缩放区域（优先级最高）
    '.DocHtmlCon', // 政府文档内容容器（如贵州政府网）
    '.TRS_PreAppend', // TRS内容管理系统（广泛用于政府网站）
    '.zwgk_content', // 政务公开内容（政务公开拼音缩写）
    '.doc_content', // 文档内容
    '.docbox', // 文档盒子
    '.article_box', // 文章盒子
    '.content_box', // 内容盒子
    ...
    '.body',
    '#body',
    // 注意：移除了 .Box 选择器，因为它在政府网站中容易过度提取整个页面布局
    // 如果需要使用通用盒子选择器，请使用更具体的如 .content_box
];
