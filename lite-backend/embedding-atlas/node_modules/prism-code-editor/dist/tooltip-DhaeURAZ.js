...
import { u as updateNode, b as getLanguage, e as getLineBefore, p as prevSelection, c as getModifierCode, g as getStyleValue, i as insertText, a as addOverlay, s as setSelection } from "./index-BvZmi6ce.js";
import { m as matchTemplate, s as searchTemplate } from "./search-Dk5fdw4x.js";
  ...
  const insertOption = (index) => {
    ...
    if (insert) {
      ...
      insert = insert.replace(/\n|	/g, (match, index2) => {
        ...
        let i = 0;
        while (i < l) {
          if (temp[i] > index2 + start) tabStops[i] += diff;
          i++;
        }
        return replacement;
      });
...
//# sourceMappingURL=tooltip-DhaeURAZ.js.map
