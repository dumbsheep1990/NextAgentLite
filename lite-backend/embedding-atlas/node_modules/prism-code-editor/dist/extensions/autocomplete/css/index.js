import { d as doc } from "../../../index-CKRNGLIi.js";
import { n as getClosestToken, f as getLineStart } from "../../../index-BvZmi6ce.js";
import { f as findWords } from "../../../tooltip-DhaeURAZ.js";
import { h as htmlTags } from "../../../data-CI2aNqpK.js";
...
const createPropCompletion = (prop, icon) => ({
  label: prop,
  icon,
  insert: prop + ": ;",
    ...
    if (getClosestToken(editor, ".tag", 0, 0, pos)) {
      ...
      if (atRuleMatch) {
        ...
        for (; bracket = brackets[i]; i++) {
          if (bracket[4] == "{" && bracket[1] < pos && brackets[pairs[i]]?.[2] > pos && !hasStyleRules.includes(before.slice(0, bracket[1]).match(atRule)?.[1])) {
