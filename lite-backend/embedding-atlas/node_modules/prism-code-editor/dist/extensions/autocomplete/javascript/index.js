import { s as space, b as braces } from "../../../jsx-shared-Dd7t2otl.js";
import { r as re } from "../../../shared-Sq5P6lf6.js";
import { n as getClosestToken } from "../../../index-BvZmi6ce.js";
import { o as optionsFromKeys, f as findWords } from "../../../tooltip-DhaeURAZ.js";
import { j as attrValueIm, k as attrValueO, l as attrValueRoles, m as attrValueY, d as attrValueB, n as attrValueEkh, o as attrValueD, p as attrValueCe, i as ariaAttributes, f as attrValueReferrerpolicy, b as attrValueXo, q as attrValueW, r as attrValueInputautocomplete, s as attrValueBt, e as attrValueTarget, t as attrValueFm, u as attrValueEt, v as attrValueT, w as attrValueM, x as attrValueS, y as attrValueSh, z as attrValueTk, A as attrValuePl, B as attrValueSb, C as attrValueLoading, c as attrValueDecoding, D as attrValueLt } from "../../../data-CI2aNqpK.js";
...
const jsContext = (context, editor) => {
  ...
  if (enabled && matcher && !tagMatch) {
    ...
    for (; bracket = brackets[i]; i++) {
      if (bracket[5] && bracket[1] < pos && brackets[pairs[i]]?.[2] > pos && /\b(?:const|let|var)\s*$/.test(before.slice(0, bracket[1]))) {
        enabled = false;
        i = 9e9;
      }
    }
...
const shouldComplete = ({ path, explicit }) => path && (path[0] || explicit);
const getFrom = ({ path, pos }) => pos - path[path.length - 1].length;
...
const _completeScope = (cache, scope, commitChars) => {
  return (context) => {
...
const identifierFilter = (value) => (type, start) => includedTypes.has(type) || type == "tag" && value[start] == "<";
...
const jsCompletion = (scope, identifiers) => {
  const cache = /* @__PURE__ */ new WeakMap();
