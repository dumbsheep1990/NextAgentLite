...
class MatGraphClientService:
    ...
    def __init__(self):
        # 从环境变量获取DataGraph服务地址，支持Docker部署和本地开发
        # 支持新旧配置名称（向后兼容）
        self.base_url = os.getenv("DATAGRAPH_SERVICE_URL") or os.getenv("MATGRAPH_SERVICE_URL", "http://localhost:9622")
        self.timeout = int(os.getenv("DATAGRAPH_REQUEST_TIMEOUT") or os.getenv("MATGRAPH_REQUEST_TIMEOUT", "30"))  # 30秒超时
        self.session = None
