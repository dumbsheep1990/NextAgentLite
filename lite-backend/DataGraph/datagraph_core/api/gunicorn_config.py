...
errorlog = os.getenv("ERROR_LOG", log_file_path)  # Default write to matgraph.log
accesslog = os.getenv("ACCESS_LOG", log_file_path)  # Default write to matgraph.log
...
# Log the location of the DataGraph log file
print(f"DataGraph log file: {log_file_path}\n")
...
def post_fork(server, worker):
    ...
    for name in logging.root.manager.loggerDict:
        if name.startswith("datagraph_core."):
