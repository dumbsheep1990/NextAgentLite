...
import { queryText, queryTextStream } from '@/api/matgraph'
...
import type { QueryMode } from '@/api/matgraph'
    ...
    <div className="flex size-full gap-2 px-2 pb-12 overflow-hidden">
      <div className="flex grow flex-col gap-4">
        ...
        <form onSubmit={handleSubmit} className="flex shrink-0 items-center gap-2">
          ...
          <Button type="submit" variant="success" disabled={isLoading} size="sm">
            <SendIcon />
